...
pub enum SecurityProfileOperation<'a> {
    ...
    #[at_arg(value = 3)]
    TrustedRootCertificateInternalName(#[at_arg(len = 200)] &'a str),
    ...
    ///       string.
    #[at_arg(value = 4)]
    ExpectedServerHostname(#[at_arg(len = 256)] &'a str),
    ...
    #[at_arg(value = 5)]
    ClientCertificateInternalName(#[at_arg(len = 200)] &'a str),
    ...
    ///       factory-programmed value is an empty string.
    #[at_arg(value = 6)]
    ClientPrivateKeyInternalName(#[at_arg(len = 200)] &'a str),
    ...
    #[at_arg(value = 7)]
    ClientPrivateKeyPassword(#[at_arg(len = 128)] &'a str),
    /// - 8: pre-shared key;
    ...
    ///       factory-programmed value is an empty string.
    #[at_arg(value = 10)]
    ServerNameIndication(#[at_arg(len = 128)] &'a str),
    ...
    #[at_arg(value = 12)]
    ServerCertificatePinning(#[at_arg(len = 200)] &'a str, PinningLevel),
