...
//         static mut WIFI_RES_Q: Option<Queue<Result<ResponseType, atat::Error>, U5, u8>> = None;
...
//         let wifi_client = atat::client::ATClient::new((wifi_req_p, wifi_res_c), 1000.ms(), Timer6);
